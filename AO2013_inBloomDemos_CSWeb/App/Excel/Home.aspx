<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="InBloomWebSite.App.Home.Home" %>
...
<head runat="server">
    ...
    <title>inBloom Excel Demo App</title>
    ...
    <script src="ExcelInteraction.js"></script>
    ...
    <script src="../inBloomScripts/GradebookEntry.js"></script>
    ...
    <script src="../inBloomScripts/StudentGradebookEntry.js"></script>
    <script src="../inBloomScripts/BulkEntityConverter.js"></script>
    <script src="SearchUI.js"></script>
    <script src="SearchDataManager.js"></script>
    <script src="BrowseUI.js"></script>
    <script src="BrowseDataManager.js"></script>
    ...
    <script src="AcceleratorExcelDemo2013.js"></script>
        ...
        <section id="mainContent">
            ...
            <article id="details">
                ...
                <div id="classDetail">
                    ...
                    <button type="button" id="analyzeButton">Add Class</button>
                </div>
                <div class="accordion">
